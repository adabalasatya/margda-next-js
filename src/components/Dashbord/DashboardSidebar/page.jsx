...
const DashboardSidebar = () => {
  ...
  return (
    <div className="bg-black shadow-lg w-[250px] max-h-screen text-white flex flex-col border-r border-gray-700">
      {/* Logo Section */}
      <div className="bg-black p-0 flex flex-col items-center justify-center border-b border-gray-700 sticky top-0 z-10">
